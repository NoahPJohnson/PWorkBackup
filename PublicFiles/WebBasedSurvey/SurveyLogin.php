...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    else
    {
        ...
        if (empty($username_err) && empty($password_err))
        {
            ...
            //echo "Query database";
            $sql = "SELECT SurveyOwnerID, Email, Password FROM SurveyOwnerTable WHERE Email = ?";
            ...
            if ($statement)
            {
                ...
                if (mysqli_stmt_execute($statement))
                {
                    ...
                    {                    
                        ...
                        if (mysqli_stmt_bind_result($statement, $resultSurveyOwnerID, $resultEmail, $hashedPassword))
                        {
                            ...
                            {   
                                if (password_verify($password, $hashedPassword))
                                {
                                    ...
                                    $_SESSION["id"] = $resultSurveyOwnerID;
                                    $_SESSION["email"] = $resultEmail;                            
                                    //echo "LOGGED IN!!";
                                    header("location: SurveysDisplay.php");
