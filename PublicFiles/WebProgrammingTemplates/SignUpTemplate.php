...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($email_error))
    {
        ...
        $sql = "INSERT INTO UserTable (admin, username, password, Email, verificationCode, Activated) VALUES (0, ?, ?, ?, ?, 1)";
        ...
        if ($statement2 = mysqli_prepare($link, $sql))
        {
            ...
            if (mysqli_stmt_execute($statement2))
            {
                ...
                echo "<script>document.location = '/npjTest/Templates/IndexTemplate.php?page=login';</script>";  
            } 
            else
            {
